...
f = open('../src/vfat2/buffers.vhd', 'w')
...
f.write("-- Description:    This entity adds differential input buffers to all VFAT2 Sbits and DataOut signals\n")
f.write("--                 and packes them inside an array.\n")
f.write("--                  This file is generated automatically by tools/gen_vfat2_vhdl.py\n")
f.write("--\n")
