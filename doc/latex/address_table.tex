...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    TOP\_SHA & \texttt{0x24} & \texttt{[31:0]} & r & \texttt{} & HOG Top SHA \\\hline
    TOP\_VER & \texttt{0x25} & \texttt{[31:0]} & r & \texttt{} & HOG Top Version \\\hline
    HOG\_SHA & \texttt{0x26} & \texttt{[31:0]} & r & \texttt{} & HOG SHA \\\hline
    HOG\_VER & \texttt{0x27} & \texttt{[31:0]} & r & \texttt{} & HOG Version \\\hline
    OH\_SHA & \texttt{0x28} & \texttt{[31:0]} & r & \texttt{} & OH SHA \\\hline
    OH\_VER & \texttt{0x29} & \texttt{[31:0]} & r & \texttt{} & OH Version \\\hline
    FLAVOUR & \texttt{0x2a} & \texttt{[31:0]} & r & \texttt{} & Flavor \\\hline
    \end{tabularx}
    \vspace{5mm}
