...
xst -ifn xst.scr
move gbt_clock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\gbt_clock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc gbt_clock_exdes.ucf gbt_clock_exdes

echo 'Running map'
map -timing -pr b gbt_clock_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm gbt_clock_exdes -w routed.ncd routed.vhd
cd ..
