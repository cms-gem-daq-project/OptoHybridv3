...
xst -ifn xst.scr
move from_gbt_des_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\from_gbt_des_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc from_gbt_des_exdes.ucf from_gbt_des_exdes

echo 'Running map'
map -timing from_gbt_des_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm from_gbt_des_exdes -w routed.ncd routed.vhd
cd ..
