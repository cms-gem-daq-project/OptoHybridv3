...
xst -ifn xst.scr
move vfat2_readout_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\vfat2_readout_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc vfat2_readout_clk_exdes.ucf vfat2_readout_clk_exdes

echo 'Running map'
map -timing -pr b vfat2_readout_clk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm vfat2_readout_clk_exdes -w routed.ncd routed.vhd
cd ..
