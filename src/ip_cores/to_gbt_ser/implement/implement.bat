...
xst -ifn xst.scr
move to_gbt_ser_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\to_gbt_ser_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc to_gbt_ser_exdes.ucf to_gbt_ser_exdes

echo 'Running map'
map -timing to_gbt_ser_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm to_gbt_ser_exdes -w routed.ncd routed.vhd
cd ..
