...
mkdir work
REM MGT Wrapper
ncvhdl -RELAX -V93 -work work   ..\..\..\sfp_gtx_gtx.vhd
ncvhdl -RELAX -V93 -work work   ..\..\..\sfp_gtx.vhd



REM Example Design modules
ncvhdl -RELAX -V93 -work work  ..\..\example_design\sfp_gtx_tx_sync.vhd
ncvhdl -RELAX -V93 -work work  ..\..\example_design\frame_gen.vhd
ncvhdl -RELAX -V93 -work work  ..\..\example_design\frame_check.vhd
ncvhdl -RELAX -V93 -work work  ..\..\example_design\sfp_gtx_top.vhd
