...
REM MGT Wrapper
vhpcomp -work work  ..\..\..\sfp_gtx_gtx.vhd
vhpcomp -work work  ..\..\..\sfp_gtx.vhd



REM Example Design modules
vhpcomp -work work  ..\..\example_design\sfp_gtx_tx_sync.vhd
vhpcomp -work work  ..\..\example_design\frame_gen.vhd
vhpcomp -work work  ..\..\example_design\frame_check.vhd
vhpcomp -work work  ..\..\example_design\sfp_gtx_top.vhd
